...
import logoImg from "figma:asset/22be3462e89c1c438f1c4a91f09367c1a4683b9a.png";
        ...
        <div className="flex items-center justify-between h-16 lg:h-[72px]">
                ...
                {item.href ? (
                  item.href.startsWith("/#") ? (
                    <a
                      ...
                      className={`px-3.5 py-2 rounded-lg text-[13px] transition-all duration-200 inline-flex items-center gap-1 ${
                        scrolled
          ...
          <button
            ...
            className={`lg:hidden p-2 rounded-full transition-colors ${
              scrolled ? "text-[#1a3a4a]" : "text-white"
            }`}
          >

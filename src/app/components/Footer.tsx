        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6 flex flex-col items-start">
              <img
                src="/images/pranavayu-logo.webp"
                alt="Pranavayu Logo"
                className="h-10 lg:h-12 w-auto brightness-0 invert opacity-90 mb-2"
              />
              <span className="text-[9px] tracking-[0.15em] uppercase text-white/30 ml-2">
            ...
            <div className="flex items-center gap-3 mt-6">
              {[
                { icon: Instagram, href: "https://www.instagram.com/pranavayu.rehabilitation/", label: "Instagram" },
                { icon: Linkedin, href: "https://www.linkedin.com/company/pranavayu-rehabilitation-", label: "LinkedIn" },
                { icon: Youtube, href: "https://www.youtube.com/@PRANAVAYUREHABILITATION-b2f", label: "YouTube" },
              ].map((social) => (
                <a
                  key={social.label}
                  href={social.href}

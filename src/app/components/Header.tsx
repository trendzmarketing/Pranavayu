...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Cardiac Rehabilitation", href: "/cardiac-rehabilitation" },
      { label: "Pulmonary Rehabilitation", href: "/pulmonary-rehabilitation" },
      { label: "Hyperbaric Oxygen Therapy", href: "/hyperbaric-oxygen-therapy" },
      { label: "Medical Rehabilitation", href: "/medical-rehabilitation" },
      { label: "Preventive Cardiology", href: "/preventive-cardiology" },
      { label: "Lifestyle Medicine", href: "/lifestyle-medicine" },
      { label: "Yoga, Nutrition & Fitness", href: "/yoga-nutrition-therapy" },
